...
function GlobalChatWindow (id : int) {
	...
	if (Event.current.type == EventType.keyDown && Event.current.character == "\n" && inputField.Length > 0)
	{
		...
		//var playerTeam = GetComponent("PlayerStats").playerTeam;
		
		ApplyGlobalChatText(inputField, 1);
		//moet in player
		//networkView.RPC("ApplyGlobalChatTextToTeam", RPCMode.Server, inputField, 0); //in SpawnPlayerLogic
...
/*@RPC
function returnTeam(team : int){
	Debug.Log("My team was : "+team);
	myTeam = team;
}*/